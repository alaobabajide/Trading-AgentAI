...
// Use the ETF proxy's exchange:ticker for the chart — the ETF tracks the index closely.
const INDEX_GROUPS: IndexGroup[] = [
  {
    ...
    entries: [
      ...
      { name: "S&P Equal Weight",  tv_symbol: "AMEX:RSP",    etf_proxy: "RSP",  description: "Equal-weighted S&P 500 — less mega-cap bias" },
  ...
  },
  {
    ...
    entries: [
      { name: "VIX (Fear Index)",  tv_symbol: "AMEX:UVXY",   etf_proxy: "UVXY", description: "Long VIX ETF — rises when S&P 500 drops sharply" },
      { name: "Short-Term VIX",    tv_symbol: "AMEX:VIXY",   etf_proxy: "VIXY", description: "ProShares VIX short-term futures ETF" },
      { name: "NASDAQ Volatility", tv_symbol: "NASDAQ:TQQQ", etf_proxy: "TQQQ", description: "3x NASDAQ 100 — amplified volatility proxy" },
  ...
  },
  {
    ...
    entries: [
      { name: "Long-Term Treasury", tv_symbol: "NASDAQ:TLT",  etf_proxy: "TLT",  description: "20+ yr US Treasury — inverse of long-end yields" },
      { name: "Short-Term Treasury",tv_symbol: "NASDAQ:SHY",  etf_proxy: "SHY",  description: "1–3 yr Treasury — tracks short-end / Fed rate" },
      { name: "Interm. Treasury",   tv_symbol: "NASDAQ:IEF",  etf_proxy: "IEF",  description: "7–10 yr Treasury — yield curve mid-point" },
      { name: "US Dollar (UUP)",    tv_symbol: "AMEX:UUP",    etf_proxy: "UUP",  description: "Invesco DB USD Index Bullish — tracks DXY" },
      { name: "Agg Bond Market",    tv_symbol: "NASDAQ:AGG",  etf_proxy: "AGG",  description: "US investment-grade bond market aggregate" },
      { name: "High Yield Bonds",   tv_symbol: "NASDAQ:HYG",  etf_proxy: "HYG",  description: "High-yield bonds — credit risk barometer" },
      { name: "TIPS (Inflation)",   tv_symbol: "NASDAQ:TIP",  etf_proxy: "TIP",  description: "Treasury inflation-protected securities" },
    ],
  },
  {
    id: "us_sector",
  ...
  },
  {
    ...
    entries: [
      { name: "Gold",              tv_symbol: "AMEX:GLD",    etf_proxy: "GLD",  description: "SPDR Gold Shares — gold price proxy" },
      { name: "Silver",            tv_symbol: "AMEX:SLV",    etf_proxy: "SLV",  description: "iShares Silver Trust — silver price proxy" },
